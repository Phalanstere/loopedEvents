...
/*
 e = {
        type: "raphael_sequence",
        div: "Titelei",
        time: 4700,
        events: [
                { type: "create_paper", width: 300, height: 200  },
                { type: "circle", cx: 50, cy: 50, r: 50, id: "MyCircle", attr: { "fill": "blue" }  },
                { type: "rect",   x: 50, y: 50, width: 50, height: 50, id: "MyRect", attr: { "fill": "green" }  },
                { type: "animate", duration: 400, attr: { cx: 50, cy: 50, r: 20, fill: "yellow"}  }
                ]
        };
