...
$(document).ready(function(){
 ...
 e = {
        ...
        time: 4200,
        duration: 200, 
        css: { width: 300, height: 300, background: "red", fontSize: "300px"}
        };
 ...
 e = {
        ...
        time: 3200,
        duration: 300,
        backgroundImage: "-webkit-linear-gradient(top, rgba(0,0,0,0), rgba(0,80,200,1) )",
 ...
 e = {
        type: "raphael",
        subtype: "progressive_path",
        time: 4500,
        duration: 920, 
        paper: "Papier",
        file: "css/setting.svg",
        attr: {  stroke: "green", "stroke-width": 3}, 
        };
